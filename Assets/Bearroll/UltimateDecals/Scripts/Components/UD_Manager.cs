...
namespace Bearroll.UltimateDecals {
	...
	public partial class UD_Manager: UD_Component {
		...
		public static void AddPermanentMark(Material material, Transform t, float normalizedAtlasOffset = 0) {

			if (instance == null) return;

			if (instance.markPass == null) return;

			instance.markPass.AddDecal(material, t, normalizedAtlasOffset);

		}

		public static void AddPermanentMark(Material material, Matrix4x4 matrix, float normalizedAtlasOffset = 0) {

			if (instance == null) return;

			if (instance.markPass == null) return;

			instance.markPass.AddDecal(material, matrix, normalizedAtlasOffset);
