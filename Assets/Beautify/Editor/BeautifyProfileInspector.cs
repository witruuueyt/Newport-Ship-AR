...
namespace BeautifyEffect {
    ...
    public class BeautifyProfilenspector : Editor {
        ...
        SerializedProperty _bloom, _bloomCullingMask, _bloomLayerMaskDownsampling, _bloomLayerZBias, _bloomIntensity, _bloomThreshold, _bloomDepthAtten, _bloomNearAtten, _bloomMaxBrightness;
        ...
        SerializedProperty _bloomBoost0, _bloomBoost1, _bloomBoost2, _bloomBoost3, _bloomBoost4, _bloomBoost5, _bloomBlur, _bloomTint;
        ...
        SerializedProperty _depthOfFieldDownsampling, _depthOfFieldMaxSamples, _depthOfFieldExclusionBias, _depthOfFieldExclusionLayerMaskDownsampling, _depthOfFieldTransparencyLayerMask;
        ...
        public override void OnInspectorGUI() {
            ...
            EditorGUILayout.PropertyField(_antialiasStrength, new GUIContent("AntiAliasing", "Intensity of edge blur antialiasing (only if AA is enabled in Shader Options)."));
