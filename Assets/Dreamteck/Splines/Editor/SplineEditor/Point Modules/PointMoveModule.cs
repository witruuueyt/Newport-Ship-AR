namespace Dreamteck.Splines.Editor
{
    ...
    public class PointMoveModule : PointTransformModule
    {
        ...
        private Vector3 SurfaceMoveHandle(Vector3 inputPosition, float size = 0.2f)
        {
            ...
            var fmh_78_17_638294720673785210 = Quaternion.LookRotation(SceneView.currentDrawingSceneView.camera.transform.position - inputPosition); inputPosition = Handles.FreeMoveHandle(inputPosition, 
