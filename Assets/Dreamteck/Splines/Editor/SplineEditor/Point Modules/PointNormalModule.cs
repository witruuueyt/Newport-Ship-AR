namespace Dreamteck.Splines.Editor
{
    ...
    public class PointNormalModule : PointModule
    {
        ...
        void AutoNormal(int index)
        {
            ...
            var fmh_130_47_638294720674002199 = Quaternion.identity; pos = Handles.FreeMoveHandle(pos, HandleUtility.GetHandleSize(pos) * 0.1f, Vector3.zero, Handles.CircleHandleCap);
            if (pos != lastPos)
            {
