namespace Dreamteck.Splines.Editor
{
    ...
    public static class SplineEditorHandles
    {
        ...
        {
            var fmh_48_53_638294720673443802 = Quaternion.identity; return Handles.FreeMoveHandle(position, size, Vector3.zero, Handles.CircleHandleCap);
        }

        public static Vector3 FreeMoveCircle(Vector3 position, float size)
        {
            var fmh_53_53_638294720673470717 = Quaternion.identity; return Handles.FreeMoveHandle(position, size, Vector3.zero, Handles.CircleHandleCap);
        }
