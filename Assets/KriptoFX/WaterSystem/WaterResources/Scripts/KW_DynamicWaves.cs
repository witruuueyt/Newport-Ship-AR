...
public class KW_DynamicWaves : MonoBehaviour
{
  ...
  //  public float DynamicWavesPropagationSpeed = 1;
    public void RenderWaves(Camera currentCamera, int fps, int areaSize, int pixelsPerMeter, float propagationSpeed, float rainStrength)
    {
        //  var bufferSize = 512;
        // var pixelSpeed = 1f;
        //var pixelSpeedRelativeToFps = 60f / fps - 1;
        // pixelSpeedRelativeToFps *= 0.25f;
        //switch (quality)
        //{
        //    case WaterSystem.QualityEnum.High:
        //        bufferSize = (int)(areaSize * ((60f / 1.0f) * 1.0f));
        //        pixelSpeed = 0.1F + pixelSpeedRelativeToFps;
        //        break;
        //    case WaterSystem.QualityEnum.Medium:
        //        bufferSize = (int)(areaSize * ((60f / 1.0f) * 0.5f));
        //        pixelSpeed = 0.25f + pixelSpeedRelativeToFps;
        //        break;
        //    case WaterSystem.QualityEnum.Low:
        //        bufferSize = (int)(areaSize * ((60f / 1.0f) * 0.25F));
        //        pixelSpeed = 0.15f + pixelSpeedRelativeToFps;
        //        break;
        //}
